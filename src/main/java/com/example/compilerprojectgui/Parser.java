...
public class Parser {
    ...
    static String filePath = "./testing.txt";
    static File file;
    static Scanner sc;
    ...
    public Parser(String filePath) throws FileNotFoundException {
        ...
        System.out.println("Parsing completed successfully without any syntax errors");
        result = "Parsing completed successfully without any syntax errors";
    ...
    public static void error(String expected) {
        ...
        result = "Error: expected token '" + expected + "' but parsed '" + currentToken.getContent() + "'" + " at line " + currentToken.lineNum;
